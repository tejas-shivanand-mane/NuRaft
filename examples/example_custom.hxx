...
void try_add_servers_if_leader() {
    if (stuff.server_id_ == 1) {
        ...
        // Add server 2
        char cmd_add2[1000] = "add 2 localhost:10002";
        ...
        // Add server 3
        char cmd_add3[1000] = "add 3 localhost:10003";
    ...
    if (stuff.server_id_ == 1)
    {
        ...
        while (std::getline(infile, line))
        {
            ...
            cmd_number++;
                ...
                std::cout << _CLM_GREEN << prompt << _CLM_END << line << std::endl;
            #else
                std::cout << prompt << line << std::endl;
            #endif
            if (line.empty()) continue;

            std::strncpy(cmd, line.c_str(), sizeof(cmd));
